...
public final class OffsetDateTimeSubject extends Subject {
        ...
        public static OffsetDateTimeSubject assertThat(String offsetDateTime) {
            return assertAbout(OFFSET_DATE_TIME_SUBJECT_FACTORY).that(OffsetDateTime.parse(offsetDateTime));
        }
        ...
        private static final Subject.Factory<OffsetDateTimeSubject, OffsetDateTime> OFFSET_DATE_TIME_SUBJECT_FACTORY =
                OffsetDateTimeSubject::new;
        ...
        public void isWithinExpectedRange() {
            ...
            if(actual.isBefore(lowerBound) || actual.isAfter(higherBound)){
                failWithActual(simpleFact("expected to be within :\n (" + lowerBound + " and " + higherBound + ")"));
            }
        }
}
